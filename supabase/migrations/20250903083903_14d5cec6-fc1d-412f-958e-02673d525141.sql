-- Create user profiles and planners for real party planning businesses in Düsseldorf, Bonn, and Cologne

-- First, create user profiles for the planners
INSERT INTO auth.users (id, email, raw_user_meta_data, created_at, updated_at, email_confirmed_at)
VALUES 
  ('a1111111-1111-1111-1111-111111111111', 'info@limelight-weddings.de', '{"full_name": "Limelight Weddings Team", "user_role": "planner"}', NOW(), NOW(), NOW()),
  ('a2222222-2222-2222-2222-222222222222', 'nadine@fineweddings.de', '{"full_name": "Nadine Metgenberg", "user_role": "planner"}', NOW(), NOW(), NOW()),
  ('a3333333-3333-3333-3333-333333333333', 'rasha@karoma-weddings.de', '{"full_name": "Rasha Abdullah", "user_role": "planner"}', NOW(), NOW(), NOW()),
  ('a4444444-4444-4444-4444-444444444444', 'info@fiesta-service.de', '{"full_name": "FIESTA SERVICE Team", "user_role": "planner"}', NOW(), NOW(), NOW()),
  ('a5555555-5555-5555-5555-555555555555', 'contact@adebar.de', '{"full_name": "Adebar Event Team", "user_role": "planner"}', NOW(), NOW(), NOW()),
  ('b1111111-1111-1111-1111-111111111111', 'info@b-ceed.de', '{"full_name": "B-ceed Events Team", "user_role": "planner"}', NOW(), NOW(), NOW()),
  ('b2222222-2222-2222-2222-222222222222', 'hello@eventiger.team', '{"full_name": "Eventiger Team", "user_role": "planner"}', NOW(), NOW(), NOW()),
  ('b3333333-3333-3333-3333-333333333333', 'info@kreativkonzept.de', '{"full_name": "Kreativ Konzept Team", "user_role": "planner"}', NOW(), NOW(), NOW()),
  ('b4444444-4444-4444-4444-444444444444', 'info@kimsam.de', '{"full_name": "Kim Sam", "user_role": "planner"}', NOW(), NOW(), NOW()),
  ('b5555555-5555-5555-5555-555555555555', 'info@2getherevent.de', '{"full_name": "2gether Event Team", "user_role": "planner"}', NOW(), NOW(), NOW()),
  ('c1111111-1111-1111-1111-111111111111', 'hello@ellenkamrad.de', '{"full_name": "Ellen Kamrad", "user_role": "planner"}', NOW(), NOW(), NOW()),
  ('c2222222-2222-2222-2222-222222222222', 'info@soundshine-entertainment.de', '{"full_name": "Soundshine Team", "user_role": "planner"}', NOW(), NOW(), NOW()),
  ('c3333333-3333-3333-3333-333333333333', 'info@diefeiermacher.de', '{"full_name": "Die Feiermacher Team", "user_role": "planner"}', NOW(), NOW(), NOW()),
  ('c4444444-4444-4444-4444-444444444444', 'info@beunique-event.de', '{"full_name": "Be Unique Team", "user_role": "planner"}', NOW(), NOW(), NOW()),
  ('c5555555-5555-5555-5555-555555555555', 'info@metz-event.de', '{"full_name": "Metz Event Team", "user_role": "planner"}', NOW(), NOW(), NOW());
...
VALUES 
  ...
  ('c3333333-3333-3333-3333-333333333333', 'Die Feiermacher', 'Event specialists with the motto "Geht nicht - gibt\'s nicht!" Comprehensive event planning for all types of celebrations from weddings to festivals.', 'Köln', 'Nordrhein-Westfalen',
