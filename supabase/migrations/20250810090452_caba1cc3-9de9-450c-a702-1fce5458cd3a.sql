...
-- Create or replace timestamp update function (safe to run multiple times)
...
create policy if not exists "Helpers can view their tasks"
...
create policy if not exists "Helpers can create their tasks"
...
create policy if not exists "Helpers can update their tasks"
...
create policy if not exists "Helpers can delete their tasks"
